 ...
 * up to version 1601602917.
 * Generated on 2020-10-02 01:41:57 by woohooo
 */
class PropelMigration_1601602917
{
    public $comment = '';
...
CREATE INDEX `variant_name` ON `variants` (`variant_name`);
...
DROP INDEX `variant_name` ON `variants`;
