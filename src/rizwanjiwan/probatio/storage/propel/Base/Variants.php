...
/**
 * Base class that represents a row from the 'variants' table.
 *
 *
 *
 * @package    propel.generator.rizwanjiwan.probatio.storage.propel.Base
 */
abstract class Variants implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\rizwanjiwan\\probatio\\storage\\propel\\Map\\VariantsTableMap';
    ...
    /**
     * Initializes internal state of rizwanjiwan\probatio\storage\propel\Base\Variants object.
     */
    ...
    /**
     * Compares this with another <code>Variants</code> instance.  If
     * <code>obj</code> is an instance of <code>Variants</code>, delegates to
     * <code>equals(Variants)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\rizwanjiwan\probatio\storage\propel\Variants The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[VariantsTableMap::COL_ID] = true;
        }
    ...
    public function settestId($v)
    {
        ...
        if ($this->test_id !== $v) {
            $this->test_id = $v;
            $this->modifiedColumns[VariantsTableMap::COL_TEST_ID] = true;
        }
    ...
    public function setVariantName($v)
    {
        ...
        if ($this->variant_name !== $v) {
            $this->variant_name = $v;
            $this->modifiedColumns[VariantsTableMap::COL_VARIANT_NAME] = true;
        }
    ...
    public function setMetadata($v)
    {
        ...
        if ($this->metadata !== $v) {
            $this->metadata = $v;
            $this->modifiedColumns[VariantsTableMap::COL_METADATA] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            if ($this->created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[VariantsTableMap::COL_CREATED] = true;
            }
    ...
    public function setUpdated($v)
    {
        ...
        if ($this->updated !== null || $dt !== null) {
            if ($this->updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[VariantsTableMap::COL_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : VariantsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : VariantsTableMap::translateFieldName('testId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->test_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : VariantsTableMap::translateFieldName('VariantName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->variant_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : VariantsTableMap::translateFieldName('Metadata', TableMap::TYPE_PHPNAME, $indexType)];
            $this->metadata = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : VariantsTableMap::translateFieldName('Created', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : VariantsTableMap::translateFieldName('Updated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 6; // 6 = VariantsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\rizwanjiwan\\probatio\\storage\\propel\\Variants'), 0, $e);
        }
    }
    ...
    {
        if ($this->aTests !== null && $this->test_id !== $this->aTests->getId()) {
            $this->aTests = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildVariantsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Variants::setDeleted()
     * @see Variants::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildVariantsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VariantsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(VariantsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(VariantsTableMap::COL_TEST_ID)) {
            $modifiedColumns[':p' . $index++]  = 'test_id';
        }
        if ($this->isColumnModified(VariantsTableMap::COL_VARIANT_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'variant_name';
        }
        if ($this->isColumnModified(VariantsTableMap::COL_METADATA)) {
            $modifiedColumns[':p' . $index++]  = 'metadata';
        }
        if ($this->isColumnModified(VariantsTableMap::COL_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'created';
        }
        if ($this->isColumnModified(VariantsTableMap::COL_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = 'updated';
        }

        $sql = sprintf(
            'INSERT INTO variants (%s) VALUES (%s)',
    ...
    {
        $pos = VariantsTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Variants'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Variants'][$this->hashCode()] = true;
        $keys = VariantsTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->gettestId(),
            $keys[2] => $this->getVariantName(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aTests) {
                ...
                $result[$key] = $this->aTests->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\rizwanjiwan\probatio\storage\propel\Variants
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setVariantName($arr[$keys[2]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\rizwanjiwan\probatio\storage\propel\Variants The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VariantsTableMap::COL_ID)) {
            $criteria->add(VariantsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(VariantsTableMap::COL_TEST_ID)) {
            $criteria->add(VariantsTableMap::COL_TEST_ID, $this->test_id);
        }
        if ($this->isColumnModified(VariantsTableMap::COL_VARIANT_NAME)) {
            $criteria->add(VariantsTableMap::COL_VARIANT_NAME, $this->variant_name);
        }
        if ($this->isColumnModified(VariantsTableMap::COL_METADATA)) {
            $criteria->add(VariantsTableMap::COL_METADATA, $this->metadata);
        }
        if ($this->isColumnModified(VariantsTableMap::COL_CREATED)) {
            $criteria->add(VariantsTableMap::COL_CREATED, $this->created);
        }
        if ($this->isColumnModified(VariantsTableMap::COL_UPDATED)) {
            $criteria->add(VariantsTableMap::COL_UPDATED, $this->updated);
        }
    ...
    {
        $criteria = ChildVariantsQuery::create();
        $criteria->add(VariantsTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \rizwanjiwan\probatio\storage\propel\Variants (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \rizwanjiwan\probatio\storage\propel\Variants Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildTests object.
     *
     * @param  ChildTests $v
     * @return $this|\rizwanjiwan\probatio\storage\propel\Variants The current object (for fluent API support)
     * @throws PropelException
     */
    public function setTests(ChildTests $v = null)
    {
        if ($v === null) {
            $this->settestId(NULL);
        } else {
        ...
        // If this object has already been added to the ChildTests object, it will not be re-added.
        if ($v !== null) {
            $v->addVariants($this);
        }
    ...
    /**
     * Get the associated ChildTests object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildTests The associated ChildTests object.
     * @throws PropelException
     */
    public function getTests(ConnectionInterface $con = null)
    {
        if ($this->aTests === null && ($this->test_id != 0)) {
            $this->aTests = ChildTestsQuery::create()->findPk($this->test_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTests->addVariantss($this);
             */
        }
     ...
     * If this ChildVariants is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildVariants The current object (for fluent API support)
     */
    public function setAssignedVariantss(Collection $assignedVariantss, ConnectionInterface $con = null)
    {
        ...
        foreach ($assignedVariantssToDelete as $assignedVariantsRemoved) {
            $assignedVariantsRemoved->setVariants(null);
        }
    ...
    protected function doAddAssignedVariants(ChildAssignedVariants $assignedVariants)
    {
        ...
        $assignedVariants->setVariants($this);
    }
    ...
    public function removeAssignedVariants(ChildAssignedVariants $assignedVariants)
    {
        if ($this->getAssignedVariantss()->contains($assignedVariants)) {
            ...
            $assignedVariants->setVariants(null);
        }
     ...
     * Otherwise if this Variants is new, it will return
     * an empty collection; or if this Variants has previously
     * been saved, it will retrieve related AssignedVariantss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Variants.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildAssignedVariants[] List of ChildAssignedVariants objects
     */
    public function getAssignedVariantssJoinVisitors(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildAssignedVariantsQuery::create(null, $criteria);
        $query->joinWith('Visitors', $joinBehavior);
    ...
    {
        if (null !== $this->aTests) {
            $this->aTests->removeVariants($this);
        }
        $this->id = null;
        $this->test_id = null;
    ...
    {
        return (string) $this->exportTo(VariantsTableMap::DEFAULT_STRING_FORMAT);
    }
